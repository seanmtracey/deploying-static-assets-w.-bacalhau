...
[Service]
ExecStart=/usr/local/bin/bacalhau serve --compute -c Compute.Orchestrators=135.181.145.8:4222 -c Compute.Enabled=true --config Compute.AllowListedLocalPaths="/var/www/html:rw"
Restart=always
RestartSec=3
User=root
